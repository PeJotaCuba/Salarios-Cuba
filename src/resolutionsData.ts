...
export const RESOLUTIONS_LIST: ResolutionData[] = [
  {
    ...
    sections: [
      ...
      },
      {
        ...
        type: "bulletList",
        bullets: [
          "Implementación del pago por resultados según el cumplimiento de los indicadores de eficiencia.",
          "El pago por condiciones de nocturnidad se mantiene vigente de acuerdo a las regulaciones de la ley laboral.",
          "Regulaciones para el pluriempleo y contratos a tiempo parcial en el sector."
        ]
      }
    ]
  },
  ...
  },
  {
    ...
    sections: [
      ...
      },
      {
        ...
        type: "bulletList",
        bullets: [
          "Retribución adicional por categoría docente o grado científico (Especialidad, Maestría, Doctorado).",
          "Carga docente máxima permitida sin afectación salarial.",
          "Compensación por años de servicio en el sector educación."
        ]
      }
    ]
  },
  {
    ...
    sections: [
      ...
      },
      {
        ...
        type: "bulletList",
        bullets: [
          "Clasificación por nivel de la instalación médica (Nivel Primario, Secundario, Terciario).",
          "Pago por guardias médicas y rotaciones nocturnas.",
          "Estipendios para residentes en formación de especialidades."
        ]
      }
    ]
  },
  {
    ...
    sections: [
      ...
      },
      {
        ...
        type: "bulletList",
        bullets: [
          "Pago por categorías de investigación (Investigador Titular, Auxiliar, Agregado).",
          "Bonos por participación en proyectos de innovación y desarrollo (I+D).",
          "Clasificación de los centros de investigación según su impacto social."
        ]
      }
    ]
  },
  {
    ...
    sections: [
      ...
      },
      {
        ...
        type: "bulletList",
        bullets: [
          "Clasificación de Oficinas del Historiador y Conservador de acuerdo a la carga patrimonial.",
          "Especialistas en restauración y conservación de grado I y II.",
          "Bonificaciones por trabajo de campo en zonas de alto valor histórico."
        ]
      }
    ]
  },
  {
    ...
    sections: [
      ...
      },
      {
        ...
        type: "bulletList",
        bullets: [
          "Evaluación artística periódica obligatoria para mantener el grupo de complejidad.",
          "Tarifas especiales para directores invitados y solistas en giras nacionales.",
          "Pagos por presentaciones en medios de difusión masiva (TV/Radio)."
        ]
      }
    ]
  },
  {
    ...
    sections: [
      ...
      },
      {
        ...
        type: "bulletList",
        bullets: [
          "Categorización de los órganos de prensa por su nivel de alcance (Nacional, Provincial, Local).",
          "Cláusulas de pago por trabajos especiales, reportajes de fondo y periodismo de investigación.",
          "Requisitos de superación profesional obligatoria."
        ]
      }
    ]
  },
